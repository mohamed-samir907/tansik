<h5 class="has-text-centered" style="margin-top: 15px">
    <span>تسجيل الرغبات</span>
</h5>
<div class="has-background-light"
    style="margin-top: 15px; margin-bottom: 10px; padding: 10px">
    <form method="POST" action="{{ route('front.add_ragaba') }}" @submit.prevent="registerRagabas" id="add_ragaba_form">
        <div class="row justify-content-left">
            {{ csrf_field() }}
            <table>
                <tr>
                    <td class="col s12" style="display: block;">
                        <label for="addRagabasSelect" style="font-weight: bold">اختر التصنيف</label>
                        <select name="type" size="5" id="addRagabasSelect" @change="addRagabas"
